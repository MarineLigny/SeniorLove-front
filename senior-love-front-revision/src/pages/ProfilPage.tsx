...
export default function ProfilePage() {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      const response = await axios.patch("http://marineligny-server.eddi.cloud/myprofile", updatedData, {
        headers: {
          Authorization: `Bearer ${storedToken}`,
  ...
  const handleUploadPhoto = async () => {
    ...
    try {
      const response = await axios.patch(
        "http://marineligny-server.eddi.cloud/myprofile",
        formData,
        {
          headers: {
            Authorization: `Bearer ${storedToken}`,
      ...
      <div className="profile_essentials">
        <div className="profile_photo">
          <img
            ...
            src={previewImage || `http://marineligny-server.eddi.cloud${profile_picture}`} //<--- il manque pas un / apress cloud???
            alt={pseudo}
          />
